...
namespace NBear.Common
{
    ...
    [Serializable]
    public class EntityArrayList<EntityType> : MarshalByRefObject, ICollection<EntityType>, IEntityArrayList
        where EntityType : Entity, new()
    {
        ...
        private EntityArrayQuery<EntityType> filter;
        ...
        /// <returns></returns>
        public EntityType[] Filter(NBear.Common.WhereClip where)
        {
        ...
        /// <returns></returns>
        public EntityType[] Filter(NBear.Common.WhereClip where, OrderByClip orderBy)
        {
            if (filter == null)
            {
                lock (this)
            ...
            return filter.FindArray(where, orderBy);
        }

        public EntityType[] Filter(NBear.Common.WhereClip where, OrderByClip orderBy, int topCount, int skipCount)
        {
            if (filter == null)
            {
                lock (this)
