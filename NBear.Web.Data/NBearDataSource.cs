            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(sql))
                {
                    ...
                    while (en.MoveNext())
                    {
                        ...
                        else if (en.Current.Value.Value is ExpressionClip)
                        {
                            sql = sql.Replace('@' + en.Current.Key, Util.ToString((ExpressionClip)en.Current.Value.Value));
                        }
                        else
                        {
                            sql = sql.Replace('@' + en.Current.Key, Util.FormatParamVal(en.Current.Value.Value));
