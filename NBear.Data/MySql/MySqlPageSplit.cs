...
namespace NBear.Data.MySql
{
	...
	/// </summary>
    [Obsolete]
	public class MySqlPageSplit : PageSplit
    {
        ...
        {
            string retStr;
            retStr = sql.Trim().TrimEnd(';') + " LIMIT {0}, {1}";
        ...
        {
            return sql.Trim().TrimEnd(';') + " LIMIT {0}";
        }
        ...
        public MySqlPageSplit(Database db, string selectStatement, string keyColumn, object[] paramValues)
