...
namespace NBear.Data.MsAccess
{
	...
	/// </summary>
    [Obsolete]
	public class AccessPageSplit : PageSplit
    {
        ...
        private string ConstructAndCacheSplitableSelectStatement(string sql, string keyColumn)
        {
            ...
            if (sql.ToLower().Substring(0, 6) == "select" && sql.ToLower().Substring(0, 10) != "select top" && keyColumn != null)
            {
                ...
                retStr = string.Format("SELECT TOP #PageSize# {0} {1} {2} {3}",
        ...
        public AccessPageSplit(Database db, string selectStatement, string keyColumn, object[] paramValues)
