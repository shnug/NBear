...
namespace NBear.Test.CaseTests.design
{
    ...
    public interface Group : Entity
    {
        ...
        [ManyToManyQuery(typeof(UserGroup), AdditionalWhere="[UserGroup].[Weight] >= 0", Contained=true)]
        User[] Users { get; set; }
    }
    ...
    public interface home_Posts : Entity
    {
        [PrimaryKey]
        int Id { get; }
        int ViewAmount { get; set; }
        int CommentAmount { get; set; }
        bool IsHide { get; set; }
        [SqlType("nvarchar(64)")]
        string Title { get; set; }
        [SqlType("nvarchar(64)")]
        ...
        [ManyToManyQuery(typeof(home_PostsInSorts), LazyLoad = true)]
        home_PostSorts[] Sorts { get; set; }
    }
    ...
    public interface home_PostSorts : home_Sorts
    {
        ...
        [ManyToManyQuery(typeof(home_PostsInSorts), LazyLoad = true)]
        home_Posts[] Posts { get; set; }
    }

    [Relation]
    public interface home_PostsInSorts: Entity
    {
        [RelationKey(typeof(home_Posts))]
        int ItemId { get; set; }

        [RelationKey(typeof(home_PostSorts))]
        int SortId { get; set; }
    }
    ...
    public interface CascadeQueryEntity1 : Entity
    {
        [PrimaryKey]
        int ID { get; }
        string Name { get; set; }
    ...
    public interface CascadeQueryEntity2 : Entity
    {
        [PrimaryKey]
        int ID { get; }
        string Name { get; set; }
        ...
        [FkReverseQuery]
        CascadeQueryEntity1 Parent1 { get; set;}
}

    public interface CascadeQueryEntity3 : Entity
    {
        [PrimaryKey]
        int ID { get; }
        string Name { get; set; }
        ...
        CascadeQueryEntity1 Parent1 { get; set;}
        [FkReverseQuery]
        CascadeQueryEntity2 Parent2 { get; set;}
    }
}
